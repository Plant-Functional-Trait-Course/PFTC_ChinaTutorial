...
This are just some scatterplots relating 2 traits values. Each dot is an observation, and each coordinate represent the value of each of the traits.Fitting traits again each other is very usefull to fit outliers and to detect weird relationships that could indicate an error in the dataset.

...
traitsLeaf$Treatment <- recode(traitsLeaf$Treatment, "1" ="warm1", "2"="cool1", "3"="warm3", "4"="cool3", "0"="local", "C"= "control", "LOCAL"="outexp", "OTC"="OTC")

traitsChem$Treatment <- recode(traitsChem$Treatment, "1" ="warm1", "2"="cool1", "3"="warm3", "4"="cool3", "0"="local", "C"= "control", "LOCAL"="outexp", "OTC"="OTC")
```

Check the levels of the Treatment: 
CHANGE TO FACTOR AS COVER_THIN
ORDENAR??
```{r Rename the treatment levels2, eval=TRUE}
unique(traitsLeaf$Treatment)
unique(traitsChem$Treatment)
levels(cover_thin$TTtreat)
```
